...
const postUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const usuarioCreado = yield usuario_1.default.create(body);
...
const putUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    //existe usuario? 
    const exiseUsuario = yield usuario_1.default.findByPk(id);
    if (!exiseUsuario) {
    ...
    try {
        yield exiseUsuario.update(body);
...
const deleteUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield exiseUsuario.update({ estado: false });
        res.json(exiseUsuario);
    }
    catch (error) {
        res.status(500).json({ msg: 'Databse error' });
